...
//                                 xmlns="http://www.w3.org/2000/svg" p-id="7147" width="24">
//                                 <path
...
//                                     fill="#d81e06" p-id="7149"></path>
//                             </svg>
//                         </div>
//                     </div>
//                     <div className="team-yq-code">
//                         <div className="yq-code-yqm">329667</div>
//                         <div className="yq-codd-btn" >Copy code</div>
//                     </div>
//                     <div className="team-yq-link">
//                         <div className="yq-link-title">Link</div>
//                         <div className="yq-link-cont">
//                             <span>https://heraeusinvest.in/home/login/register/invite_code/329667.html</span>
//                             <div className="yq-link-cont-btn"
//                                 >Copy
//                             </div>
//                         </div>
//                     </div>
//                    <input id="webcopyinput" type="text" style={{left: "-1000px", position: "absolute"}}></input>
//                 </div>
//                 <div className="invite-friends">
//                     <div className="invite-friends-cont">Invite Friends To Complete The First Investment And Get
//                         <span>₹60.00</span>
//                         <div className="invBtn">
//                             <input type="button" className="btnCNot" data-val="7" fdprocessedid="19x62" />
//                         </div>
//                     </div>
//                 </div>
...
//                             <div className="team-dj-cont">Commission rate:
//                                 <span>0%</span>
//                             </div>
//                         </div>
...
//                                 <strong>
//                                     <span style={{fontSize: "18px"}}>Team Rewards:</span>
//                                 </strong>
//                             </span>
//                         </p>
//                         <p>
...
//                             <span style={{color: "ff0000"}}>
//                                 <strong>
//                                     <span style={{fontSize: "18px"}}>Level 1 Members: 20%</span>
//                                 </strong>
//                             </span>
//                         </p>
//                         <p>
...
//                             <span style={{color: "ff0000"}}>
//                                 <strong>
//                                     <span style={{fontSize: "18px"}}>Level 2 Members: 3%</span>
//                                 </strong>
//                             </span>
//                         </p>
//                         <p>
...
//                             <span style={{color: "ff0000"}}>
//                                 <strong>
//                                     <span style={{fontSize: "18px"}}>Level 3 Members: 3%</span>
//                                 </strong>
//                             </span>
//                         </p>
//                         <p>
...
//                             <span style={{color: "ff0000"}}>
//                                 <strong>
//                                     <span style={{fontSize: "18px"}}>Rewards can be claimed indefinitely</span>
//                                 </strong>
//                             </span>
//                         </p>
//                         <p>
      ...
      <main>
        ...
        <div className="create-team">
          <div>
              ...
              <span style={{ color: '#ff0000' }}>
                <strong>
                  <span style={{ fontSize: '18px' }}>
                    Rewards can be claimed indefinitely
                  </span>
                </strong>
              </span>
            </p>
            <p>
              <span style={{ color: '#ff0000', fontSize: '18px' }}>
                <strong>VIP product team rewards</strong>
              </span>
            </p>
            <p>
              <span style={{ color: '#ff0000', fontSize: '18px' }}>
                <strong>Level 1 Members: 10%</strong>
              </span>
            </p>
            <p>
              <span style={{ color: '#ff0000', fontSize: '18px' }}>
                <strong>Level 2 Members: 3%</strong>
              </span>
            </p>
            <p>
              <span style={{ color: '#ff0000', fontSize: '18px' }}>
                <strong>Level 3 Members: 2%</strong>
              </span>
            </p>
          </div>
        </div>
